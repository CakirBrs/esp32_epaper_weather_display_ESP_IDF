...
extern const uint8_t FreeMonoBold12pt7bBitmaps[]; // Bitmap verileri
extern const GFXglyph FreeMonoBold12pt7bGlyphs[]; // Glif bilgileri
extern const GFXfont FreeMonoBold12pt7b;         // Font yapısı
